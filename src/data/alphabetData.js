...
export const uiTranslations = {
  en: { read: 'Read', cycle: 'Cycle', settings: 'Settings', language: 'Language',
        ...
        feedback: 'Feedback', feedbackName: 'Your name', feedbackEmail: 'Your email',
  ...
  ar: { read: 'قراءة', cycle: 'تكرار', settings: 'إعدادات', language: 'اللغة',
        ...
        feedback: 'ملاحظات', feedbackName: 'اسمك', feedbackEmail: 'بريدك الإلكتروني',
  ...
  he: { read: 'קרא', cycle: 'חזרה', settings: 'הגדרות', language: 'שפה',
        ...
        feedback: 'משוב', feedbackName: 'השם שלך', feedbackEmail: 'האימייל שלך',
  ...
  om: { read: 'Dubbisi', cycle: 'Irra deebi\'i', settings: 'Qindaa\'ina', language: 'Afaan',
        ...
        feedback: 'Yaada', feedbackName: 'Maqaa kee', feedbackEmail: 'Imeelii kee',
